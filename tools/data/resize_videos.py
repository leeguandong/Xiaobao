...
def parse_args():
    ...
    parser.add_argument('--src_dir', default=r'E:\comprehensive_library\mmaction2_add\data\tiny-Kinetics-400\videos_train',
                        type=str, help='source video directory')
    parser.add_argument('--out_dir', default=r'E:\comprehensive_library\mmaction2_add\data\tiny-Kinetics-400\videos_train',
                        type=str, help='output video directory')
    parser.add_argument(
        '--dense',
        action='store_true',
        help='whether to generate a faster cache')  # 是否生成快速缓存
    parser.add_argument(
        '--level',
        type=int,
        choices=[1, 2],
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='whether to remove duplicated frames')  # 去重
    parser.add_argument(
        '--ext',
        type=str,
        default='mp4',
