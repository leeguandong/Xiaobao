...
def extract_frame(vid_item):
    ...
    """
    full_path, vid_path, vid_id, method, task, report_file, args = vid_item
    # if '/' in vid_path:
...
def parse_args():
    ...
    parser.add_argument('--src_dir',
                        default=r'E:\comprehensive_library\mmaction2_add\data\tiny-Kinetics-400\videos_val',
                        type=str, help='source video directory')
    parser.add_argument('--out_dir', default=r'E:\comprehensive_library\mmaction2_add\data\tiny-Kinetics-400\rawframes_val',
                        type=str, help='output rawframe directory')
    parser.add_argument(
        '--task',
        type=str,
        default='rgb',
    ...
    parser.add_argument(
        '--report-file',
        type=str,
        default='build_report_train.txt',
