...
def parse_directory(path,
    ...
    if level == 1:
        ...
        def locate_directory(x):
            ...
            return osp.basename(osp.dirname(x)) + "/" + osp.basename(x)
...
def parse_kinetics_splits(level, dataset):
    ...
    kinetics = "E:/comprehensive_library/mmaction2_add"
    train_file = os.path.join(kinetics, f'data/{dataset}/annotations/kinetics_train.csv')
    val_file = os.path.join(kinetics, f'data/{dataset}/annotations/kinetics_val.csv')
    test_file = os.path.join(kinetics, f'data/{dataset}/annotations/kinetics_val.csv')
