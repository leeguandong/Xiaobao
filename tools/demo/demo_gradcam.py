...
def parse_args():
    ...
    parser.add_argument('--config',
                        default=os.path.join(path, r'configs\recognition\tsm\tsm_r50_video_inference_1x1x8_100e_kinetics400_rgb.py'),
                        help='test config file path')
    parser.add_argument('--checkpoint',
                        default=os.path.join(path, r"\weights\tsm_r50_video_1x1x8_100e_kinetics400_rgb_20200702-a77f4328.pth"),
                        help='checkpoint file/url')
    parser.add_argument('--video',
                        default=os.path.join(path, r"data\test\panshouwan.mp4"),
    ...
    parser.add_argument(
        '--target-layer-name',
        type=str,
        default='backbone/layer4/1/relu', # 需要生成 GradCAM 可视化的网络层名称
        help='GradCAM target layer name')
    parser.add_argument('--out-filename',
                        default=os.path.join(path, r"data\cache\demo_tsm_gram.gif"),
