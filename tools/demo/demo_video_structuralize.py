...
def parse_args():
    ...
    parser.add_argument(
        ...
        help='rgb-based spatio temporal detection config file path') # 基于 RGB 的时空检测配置文件路径
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=('https://download.openmmlab.com/mmaction/skeleton/posec3d/'
                 'posec3d_ava.pth'),
        help='skeleton-based spatio temporal detection checkpoint file/url') # 基于人体姿态的时空检测模型权重文件路径
    parser.add_argument(
        '--det-config',
        default='demo/faster_rcnn_r50_fpn_2x_coco.py',
        help='human detection config file path (from mmdet)')  # 人体检测配置文件路径
    parser.add_argument(
        '--det-checkpoint',
    ...
    parser.add_argument(
        ...
        help='human pose estimation config file path (from mmpose)') # 人体姿态估计模型配置文件路径 (需在 COCO-keypoint 数据集上训练)
    parser.add_argument(
        '--pose-checkpoint',
    ...
    parser.add_argument(
        ...
        help='skeleton-based action recognition config file path') # 基于人体姿态的动作识别模型配置文件路径
    parser.add_argument(
        '--skeleton-checkpoint',
        default='https://download.openmmlab.com/mmaction/skeleton/posec3d/'
        'posec3d_k400.pth',
    ...
    parser.add_argument(
        ...
        help='rgb-based action recognition config file path') # 基于 RGB 的行为识别配置文件路径
    parser.add_argument(
        '--rgb-checkpoint',
    ...
    parser.add_argument(
        '--use-skeleton-stdet',
        action='store_true',
        help='use skeleton-based spatio temporal detection method') # 使用基于人体姿态的时空检测方法
    parser.add_argument(
        '--use-skeleton-recog',
        action='store_true',
        help='use skeleton-based action recognition method') # 使用基于人体姿态的行为识别方法
    parser.add_argument(
        '--det-score-thr',
        type=float,
        default=0.9,
