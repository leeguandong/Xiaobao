...
import math
from pphumanseg.src.infer import Predictor
...
class args_cls(object):
    use_gpu = True
    config = os.path.join(r'F:\Dataset\qiantu\Sports_Game_tracker-main\sports_game_tracker','python', 'pphumanseg', 'inference_models',
